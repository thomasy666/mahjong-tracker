...
const resources = {
  ...
  zh: {
    translation: {
      ...
      currentSession: '当前场次',
      noSession: '无场次（默认）',
      newSessionName: '新场次名称',
      newSession: '新建',
      savedSessions: '已保存场次',
      noSavedSessions: '暂无保存的场次',
      load: '加载',
      confirmDeleteSession: '删除此场次及其所有回合？',
      showAll: '+{{count}} 更多',
      showLess: '收起',
    },
  },
